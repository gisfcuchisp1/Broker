<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new_cap.aspx.cs" Inherits="Broker_CAPAlertPosting_new_cap" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
 "http://www.w3.org/TR/html4/loose.dtd">
<html>
<!--
MASAS Posting Tool - New CAP Alert
Updated: Dec 11, 2012
...
<head>
  ...
  <script src="http://maps.google.com/maps/api/js?v=3.8&amp;sensor=false" type="text/javascript"></script>
 <!-- Google Maps via HTTPS -->
  ...
  <script type="text/javascript">
      ...
      MASAS.FEED_URL = '<%= System.Web.Configuration.WebConfigurationManager.AppSettings["CapAlertSeed"] %>';
      <%-- MASAS.USER_SECRET = 'dh4nhz'; --%>
      MASAS.USER_URI = 'https://access.masas-sics.ca/accounts/user/76/';

      // event list URL
      MASAS.EVENT_LIST_URL = 'utils/get_events.js';
      ...
      MASAS.AJAX_PROXY_URL = 'go.ashx?url=';
      ...
      eventStations = <%= eventStationsJson %>;
      ...
      //MASAS.EMAIL_FOOTER = '\nThis is the footer';
      // set custom values for Status, otherwise comment out to use defaults
      //MASAS.CUSTOM_STATUS_VALUES = [ ['Actual', 'Actual Entries'], ['Test', 'Test Entries'] ];
